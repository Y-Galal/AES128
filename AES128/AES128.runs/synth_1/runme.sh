...
HD_PWD='E:/Working/Digital Design/Projects/AES/AES-Repo/AES128/AES128.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shiftRows.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shiftRows.tcl
